                               ...
                               <div>
                                 <!-- <div class="row"> -->
                                    ...
                                    <section class="listing-main">
                                      <div class="container">
                                        <div class="row">
                                          <h1 class="main-title">Main Product Reviews</h1>
                                          ...
                                          <div class="col-sm-4 <?php echo $classname ?>-prod">
                                            <div class="prod-img">
                                      ...
                                      <div class="container">
                                        ...
                                        ?>
                                          ...
                                          <div class="col-md-6 left-col-wrap">
                                            ...
                                            <p class="descr"><?php the_excerpt(); ?></p>
                                            <p class="descr"><?php the_field('prod_rev_featured', 133); ?></p>
                                            </div>
                                          </div>
                                          <div class="col-md-6 right__col" style="background-image: url(<?php the_field('prod_rev_featured_img', 133); ?>)">                                            
                                          </div>
                                          <?php  
                                              endwhile;
                                              wp_reset_postdata();
                                      ...
                                      <div class="container">
                                        <div class="row">
                                          <div class="inner">
                                            ...
                                            <div class="col-sm-6 col-lg-3 blog-col">
