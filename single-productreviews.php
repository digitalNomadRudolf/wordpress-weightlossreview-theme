<?php get_header(); ?>
                   ...
                   <section class="sub-main-single">
                       <div class="container ">
                                    <!-- like the blog page but a bit different. -->
                                    <!-- up at the top in the big purple box it will always contain the title of the page  -->
                        <!-- content will contain A grand title, an image, medium sized, h3 titles and p's, content images, and a summary -->
